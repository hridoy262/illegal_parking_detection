...
Place the input video files in the adminResources/input/ directory.
Run the illegal_parking_detection.py script:
python illegal_parking_detection.py
The output video with detected violations will be saved in the adminResources/output/ directory.
Configuration
